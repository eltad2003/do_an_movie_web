    ...
    <div>
      ...
      <table className='w-full'>
        <thead className='bg-gray-50 border-b border-gray-200'>
          <tr>
            <th className='px-6 text-left text-gray-500 uppercase'>STT</th>
            <th className='px-6 text-left text-gray-500 uppercase'>Tên tập</th>
            <th className='px-6 text-left text-gray-500 uppercase'>URL video</th>
            <th className='px-6 text-left text-gray-500 uppercase'>Thao tác</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-gray-200">
          {episodes.map((episode, index) => (
            <tr key={index} className='hover:bg-gray-50'>
              ...
              <td className="px-6 py-4 text-blue-500">{episode.video_url}</td>
