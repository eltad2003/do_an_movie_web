    ...
    return (
        <form onSubmit={handleSubmitSearch} className="my-20 px-6">
            <div className="relative bg-white rounded-2xl mx-auto max-w-5xl" >
                ...
                <input
                    type="search"
                    className="w-full bg-transparent py-4 sm:pr-10 pl-10  outline-hidden"
                    ...
                    required
                />
                <button type="submit" className=" absolute end-2 bottom-2 btn disabled:cursor-not-allowed" disabled={!searchQuery.trim()}>Tìm kiếm</button>
            </div>
        </form>
